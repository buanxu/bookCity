...
<%--			静态包含  manager模块管理菜单--%>
		...
		<div id="main">
			...
			<form action="manager/bookController?action=${empty param.id ? "add":"update"}&pageNo=${param.pageNo}&curPageCounts=${param.curPageCounts}&id=${requestScope.book.id}" enctype="multipart/form-data" method="post">
